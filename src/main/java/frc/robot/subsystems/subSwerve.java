...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  throws IOException, ParseException
  {
    ...
    try {
      setpointGenerator = new SwerveSetpointGenerator(RobotConfig.fromGUISettings(),
  ...
  public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY, DoubleSupplier angularRotationX, BooleanSupplier fieldRelative)
  {
    return run(() -> {
      // Make the robot move
      swerveDrive.drive(SwerveMath.scaleTranslation(new Translation2d(
