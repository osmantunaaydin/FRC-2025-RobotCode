...
public class cmdAuto_Align3Robot extends Command {
  subSwerve swerve;
  subLimelight limelight;
  PIDController pidHorizontalController = new PIDController(0.06, 0.01, 0.01);
  PIDController pidDistanceController = new PIDController(0.06, 0.01, 0.01);
  ...
  public cmdAuto_Align3Robot(subSwerve swerve, subLimelight lime) {
    this.swerve = swerve;
    this.limelight = lime;
    pidHorizontalController.setSetpoint(-12);
    pidDistanceController.setSetpoint(-9.75);
